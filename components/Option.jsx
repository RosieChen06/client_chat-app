...
const Option = React.memo(({setGroupName, prevInfoRef, userInfo, setSwitchTo, swithTo, setReceiver, setIsProfileEdit, userImage, setIsLogin}) => {
    ...
    <div className="flex bg-white flex-row md:flex-col justify-center md:justify-start items-center h-full">
        ...
        <div className="flex gap-16 md:gap-6 py-2 flex-row md:flex-col items-center md:mt-4">
            ...
            <div className={`p-2 rounded-md cursor-pointer ${swithTo==='People'?'bg-slate-200':'hover:bg-slate-200'}`} onClick={()=>{setSwitchTo('People'); setReceiver({name:'', mail:'', image:''}); prevInfoRef.current=null}}>
